...
import static com.example.lukas.newsapp.NewsActivity.LOG_TAG;

public final class QueryHelperClass {

    /**
     * Create a private constructor because no one should ever create a {@link QueryHelperClass} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name QueryUtils (and an object instance of QueryUtils is not needed).
     */
    private QueryHelperClass() {
    }
    ...
    public static List<News> extractFeatureFromJson(String newsJson) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                News newArticle = new News(section, author, title, dateTime, url);
            ...
            Log.e("QueryHelperClass", "Problem parsing the article JSON results", e);
        }
